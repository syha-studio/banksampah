                    ...
                    <table class="w-full text-sm text-left text-design-secondary dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-start">Jenis Sampah</th>
                                <th scope="col" class="px-4 py-3 text-center">Satuan</th>
                                <th scope="col" class="px-4 py-3 text-end">Harga Terkini</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">Randegan, Sidoarjo</td>
                                <td class="px-4 py-3 text-start">Aluminium</td>
                                <td class="px-4 py-3 text-center">kg</td>
                                <td class="px-4 py-3 text-end">Rp 900</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
