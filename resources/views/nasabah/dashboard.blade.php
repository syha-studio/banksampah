<x-layout-nasabah>
    ...
    <div class="p-4 mt-14">
        ...
        <div class="grid grid-cols-8 gap-4 mb-4">
            <div
                class="w-full col-span-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between p-6">
                    <div class="flex flex-row items-center">
                        <img class="w-28 h-28 mx-4 shadow-lg rounded-full" src="/img/avatar-default.png"
                            alt="Foto Avatar" />
                        <div>
                            <h6 class="mb-1 text-base font-medium text-gray-900 dark:text-white">
                                {{ auth()->user()->branch->name }}</h6>
                    ...
                    <div>
                        <button data-modal-target="profile-edit" data-modal-toggle="profile-edit" type="button">
                            <p class="text-sm font-medium">
                                <svg class="w-6 h-6 text-design-primary dark:text-white" aria-hidden="true"
            ...
            <div
                class="flex items-center col-span-3 justify-start w-full  bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <a href="/saldo" class="p-6 w-full">
                    <h5 class="mb-2 text-2xl font-bold justify-start tracking-tight text-gray-900 dark:text-white">Saldo
                    </h5>
        ...
        <div
            class="w-full mb-4 p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    <li class="py-3 sm:py-4">
                        <div class="flex items-center">
                                ...
                                @foreach ($pickups as $pickup)
                                    <div class="flex-1 min-w-0 ms-4">
                                        <div class="flex items-center justify-start">
                                            ...
                                            @if ($pickup->status->id == 1)
                                                <span class="ml-2">
                                                    <form action="{{ route('pickup.cancel1', $pickup->id) }}"
                            ...
                            @else
                                <div
                                    class="flex justify-center items-center h-full w-full text-center text-base font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <div class="flex-1 min-w-0 ms-4">
                                        <div class="flex items-center justify-start">
                                            ...
                                            @if ($withdrawActive->status->id == 1)
                                                <span class="ml-2">
                                                    <form action="{{ route('transfer.cancel', $withdrawActive->id) }}"
                                                        method="POST" class="inline">
                                                        @csrf
                                                        <button type="submit" class="text-red-500">Batal</button>
                                                    </form>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="/history"
                        class="text-sm font-medium text-design-primary hover:underline dark:text-blue-500">
                        View all
                    </a>
                </div>
                <div class="flow-root">
    ...
    <div class="fixed end-6 bottom-6">
        <!-- Button modal -->
        <button
            @if ($pickups->isNotEmpty()) disabled data-tooltip-target="tooltip-left" data-tooltip-placement="left" @endif
            type="button" data-modal-target="popup-modal" data-modal-toggle="popup-modal"
            class="flex items-center justify-center text-white bg-design-primary rounded-lg w-14 h-14 hover:bg-green-200 focus:ring-4 focus:ring-green-200 focus:outline-none">
