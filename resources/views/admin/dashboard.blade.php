<x-layout-admin>
    ...
    <div class="p-4 mt-14">
      <div class="grid grid-cols-8 gap-4 mb-4">
         <div class="w-full col-span-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex justify-between p-6">
               <div class="flex flex-row items-center">
                  <img class="w-28 h-28 mx-4 shadow-lg rounded-full" src="/img/avatar.png" alt="Foto Avatar"/>
                  <div>
                     <h6 class="mb-1 text-base font-medium text-gray-900 dark:text-white">Banks BIMA</h6>
                     <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Cabang Rungkut Mega</h5>
                     ...
                     <p class="text-sm text-gray-500 dark:text-gray-400">087123459999</p>
                  </div>
               </div>
               <div>
         ...
         <div class="flex items-center col-span-4 justify-start w-full  bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <a href="/saldo" class="p-6 w-full">
               ...
               <div class="flex items-center justify-between">
                  ...
                  <p class="font-normal text-4xl text-gray-700 dark:text-gray-400">50.000.000</p>
               </div>
            </a>
         </div>
      </div>
